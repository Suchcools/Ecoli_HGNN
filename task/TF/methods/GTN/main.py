...
def load_data(args):
    ...
    return node_features, edges, labels, dl, w_ins, test_target
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, default="GTN")
    ...
    node_features, edges, labels, dl, w_ins, test_target = load_data(args)
    ...
    for l in range(1):
        ...
        for i in range(epochs):
            ...
            with torch.no_grad():
                ...
                np.savez(f"../../output/baseline/{args.name}.npz", label=test_target, prob=y_test.detach().cpu())

...
for random_state in tqdm(range(1,101)):
    path = f"../data/INS_LP/{random_state}"
    ...
    link = pd.read_csv(f'{path}/link.dat',sep='\t',header=None)
    link
    ...
    nodedat = open(f'{path}/link.dat.test', 'w', encoding='utf-8')
